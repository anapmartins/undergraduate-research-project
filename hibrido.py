...
# valores utilizados no algoritmo genetico e firefly
TAM_POPULACAO = 100
NUM_GERACOES = 1000
TAXA_MUTACAO = 0.1
PROB_MELHOR = 0.8
...
def gera_nova_populacao(pais, populacao, distancia_vazio, distancia_cheio, distancia_talhoes):
	...
	# seleciona os melhores da populacao de acordo com o tamanho da populacao
	...
	pop = [x[0] for x in pop_and_fit[:TAM_POPULACAO]]
